...
public class PanelConfiguracion extends JPanel {
	...
	private PanelConfiguracion() {
		...
		label = new Label("Seleccione el número de nivel desde el cual se quiere iniciar el juego:");
		panel2.add(label);
		for (int i = 1; i <= 20; i++) {
			nivelInicial.add("" + i);
		}
		panel2.add(nivelInicial);
		label2 = new Label("Seleccione el número de valores que serán almacenados en la tabla de ranking:");
		panel2.add(label2);
