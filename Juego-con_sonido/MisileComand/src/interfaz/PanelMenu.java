	...
	private PanelMenu() {
		...
		b.addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent e) {
				...
				VentanaPrincipal.getInstancia().pack();
				VentanaPrincipal.getInstancia().getMusica().stop();
				VentanaPrincipal.getInstancia().getMusica().flush();
				VentanaPrincipal.getInstancia().getMusica().drain();
				VentanaPrincipal.getInstancia().getMusica().close();
