...
public class Observador {
	...
	public void destruccionBombardero() {
		...
		for (OndaExpansiva o : explosiones) {
			...
			if ((distanciaEntreDosPuntos(Enemigo.getInstancia().getB().getActual(), o.getPos())) <= (o.getRadio()
				...
				Enemigo.getInstancia().getB().getSonidoExplosion().start();
				Enemigo.getInstancia().getB().getSonido().stop();
				Enemigo.getInstancia().getB().getSonido().flush();
				Enemigo.getInstancia().getB().getSonido().drain();
				Enemigo.getInstancia().getB().getSonido().close();
	...
	public void liberarMemoria(){
		for (Misil mab : mabDestruidos) {
			mab.getSonidoExplosion().stop();
			mab.getSonidoExplosion().flush();
			mab.getSonidoExplosion().drain();
			mab.getSonidoExplosion().close();
		}
		for (Misil mk : mbiDestruidos) {
			mk.getSonidoExplosion().stop();
			mk.getSonidoExplosion().flush();
			mk.getSonidoExplosion().drain();
			mk.getSonidoExplosion().close();
		}
